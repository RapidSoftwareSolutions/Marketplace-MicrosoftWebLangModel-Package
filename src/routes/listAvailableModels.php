...
$app->post('/api/MicrosoftWebLangModel/listAvailableModels', function ($request, $response) {
    ...
    $query_str = "https://westus.api.cognitive.microsoft.com/text/weblm/v1.0/models";
